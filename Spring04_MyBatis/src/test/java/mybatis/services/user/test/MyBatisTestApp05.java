...
public class MyBatisTestApp05 {
	...
	public static void main(String[] args) throws Exception{
		...
		//==>@@@ null값을 허용할려면 SqlMapConfig01.xml에 Settings 태그를 부착해야한다.@@@ (mysql은 괜찮지만, oracle에서는 에러가 나기 때문)
		...
		//4. user05 아이디를 가진 사람을 삭제하는 단위테스트 작성
		user.setUserId("user05");
		System.out.println(":: 4. remove(delete)  ? "
													+ session.delete("UserMapper05.updateUser",user.getUserId()));
		session.commit();
	}//end of main
}//end of class
